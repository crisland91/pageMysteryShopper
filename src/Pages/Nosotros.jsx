...
export default function Nosotros() {
  ...
  return (
    <section className="bg-gray-100 py-10 px-6 md:px-16 lg:px-14 lg:pt-20 pt-24 ">
      <div className="flex flex-col lg:flex-row items-center" data-aos="zoom-out">
        {/* Texto (lado izquierdo) */}
        <div className="xl:w-4/6 lg:w-7/12  mb-8 lg:mb-0 lg:pr-10 ">
          <h2 className="text-5xl font-bold text-blue-800 mb-4 sm:text-center oswald-font">
            Acerca de nosotros
          </h2>
          <p className="text-gray-900 text-xl font-semibold leading-relaxed sm:text-justify">
        ...
        {/* Imagen (lado derecho) */}
        <div className="xl:w-2/6 lg:w-5/12 lg:h-[700px] md:w-[500px]  lg:py-10 lg:flex lg:justify-center " >
          <img
